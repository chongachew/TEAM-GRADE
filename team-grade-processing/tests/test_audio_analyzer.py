"""
Unit tests for processing/audio_analyzer.py.

Ported from a standalone preprocessor/ PR that was never wired into the real
pipeline - test cases unchanged, only the module paths (processing.audio_analyzer,
config.settings instead of preprocessor.audio_analyzer, preprocessor.config).
...
from processing.audio_analyzer import (
    AudioAnalyzer,
