...
export default function PlaysGrid({ reps, claimedTrackId, onSeek }) {
  if (!reps.length) {
    ...
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
      {reps.map((rep) => (
        <button
          ...
          className={`flex flex-col items-start gap-1 rounded-lg border p-3 text-left transition hover:border-bridge-gold/60 disabled:cursor-default disabled:opacity-60 ${
